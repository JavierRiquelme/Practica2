            ...
            <div class="card card-shadowed p-50 w-400 mb-0" style="max-width: 100%">
                ...
                <form>
                  ...
                  <div class="form-group">
                    <input type="text" class="form-comtrol" placeholder="Email" v-model="email">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-comtrol" placeholder="Password" v-model="password">
                  </div>
                  <div class="form-group flexbox py-10">
                    <label class="custom-control custom-checkbox">
                      <input type="checkbox" class="custom-control-input" v-model="remember">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description">Remerber me</span>
                    </label>
        ...
        attemptLogin(){
          ...
          axios.post('/login', {
            ...
            if(error.response.status == 422){
              ...
              this.errors.push("Somthing went wrong, please refresh and try again.")
            }
          })
        }  
      },
