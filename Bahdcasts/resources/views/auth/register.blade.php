...
<html lang="en">
  <head>
    ...
    <!-- Styles -->
    <link href="theme/assets/css/core.min.css" rel="stylesheet">
    <link href="theme/assets/css/thesaas.min.css" rel="stylesheet">
    <link href="theme/assets/css/style.css" rel="stylesheet">

    <!-- Favicons -->
    <link rel="apple-touch-icon" href="theme/assets/img/apple-touch-icon.png">
    <link rel="icon" href="theme/assets/img/favicon.png">
  </head>

  <body class="mh-fullscreen bg-img center-vh p-20" style="background-image: url(theme/assets/img/bg-girl.jpg);">
    ...
    <script src="theme/assets/js/thesaas.min.js"></script>
